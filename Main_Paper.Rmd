...
plot(NULL, xlim = c(1995,2025), 
     ...
     xlab = "Time (years)",
     ylab = "Cases",
     main = expression(paste("In-Sample Forecast of Series", ~italic("y"[1]))))
...
plot(NULL, xlim = c(1995,2025), ylim = c(-30,230),
     xlab = "Time (years)",
     ylab = "Cases",
     main = expression(paste("In-Sample Forecast of Series",
                             ~italic("y"[2]))))
...
#plot.ts(xd.new2[, 2], type = "l", 
        ...
        #xlab = "Time (years)",
        #ylab = "Cases",
        #main = expression(paste("In-Sample Forecast of Series", ~italic("y"[2]))))
...
plot(NULL, xlim = c(1995,2024), ylim = c(0, 450),
     xlab = "Time (years)", ylab = "Cases",
     main = expression(paste("In-sample Forecast of ", "y"[1])))
...
plot(NULL, xlim = c(1995,2024), ylim = c(0, 230),
     xlab = "Time (years)", ylab = "Cases",
     main = expression(paste("In-sample Forecast of ", "y"[2])))
...
estimD1 = window(up_x.trtb2, 
                  end = c(2015, 1))
estimD2 = window(up_x.trtb2, end = c(2016, 1))
estimD3 = window(up_x.trtb2, end = c(2017, 1))
estimD4 = window(up_x.trtb2, end = c(2018, 1))
estimD5 = window(up_x.trtb2, end = c(2019, 1))
estimD6 = window(up_x.trtb2, end = c(2020, 1))
estimD7 = window(up_x.trtb2, end = c(2021, 1))
estimD8 = window(up_x.trtb2, end = c(2022, 1))
estimD9 = window(up_x.trtb2, end = c(2023, 1))
...
```{r}
# Models
M1 = VAR(estimD1, p = 2, type = "both")
M2 = VAR(estimD2, p = 2, type = "both")
M3 = VAR(estimD3, p = 2, type = "both")
M4 = VAR(estimD4, p = 2, type = "both")
M5 = VAR(estimD5, p = 2, type = "both")
M6 = VAR(estimD6, p = 2, type = "both")
M7 = VAR(estimD7, p = 2, type = "both")
M8 = VAR(estimD8, p = 2, type = "both")
M9 = VAR(estimD9, p = 2, type = "both")
```
...
# forecasts
L = 21
M.1 = VAR(dat.Y[1:L, ], p = 2, type = "both")

fcs.E1 = predict(M.1, n.ahead = 9,
                 ci = 0.95, dumvar = NULL)
```
